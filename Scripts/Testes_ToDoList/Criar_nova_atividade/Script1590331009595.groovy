...
WebUI.verifyElementPresent(findTestObject('ToDoPage/ul_list'), 5)

def valorInicial = CustomKeywords.'ListaToDo.listaQuantidadeDeElementos'(findTestObject('ToDoPage/ul_list'))

//exercício
WebUI.setText(findTestObject('ToDoPage/input_task'), 
    'Realizar um teste no katalon')

WebUI.sendKeys(findTestObject('ToDoPage/input_task'), 
